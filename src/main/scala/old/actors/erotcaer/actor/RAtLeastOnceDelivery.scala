...
/**
  ...
  */
trait RAtLeastOnceDelivery extends PersistentActor with RAtLeastOnceDeliveryLike

/**
  * @see [[AtLeastOnceDelivery]]
  */
trait RAtLeastOnceDeliveryLike extends Eventsourced {
  ...
  /**
    ...
    * configuration key. This method can be overridden by implementation old.classes to return
    * non-default values.
    */
