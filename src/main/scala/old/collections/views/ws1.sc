...
/**
  * Source
  * https://alvinalexander.com/scala/how-to-create-lazy-views-old.collections-scala-cookbook
  */
...
println("%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%")
/**
  * Source:http://www.scala-lang.org/docu/files/old.collections-api/collections_42.html
  */
